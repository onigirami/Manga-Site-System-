...
(function($) {
    ...
    $(document).ready(function() {
        ...
        // Edit manga action
        $(document).on('click', '.edit-manga', function(e) {
            e.preventDefault();
            const mangaId = $(this).data('id');
            // Usar URL relativa que funciona com o shortcode
            window.location.href = window.location.pathname + '?view=edit&id=' + mangaId;
        });
    });
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            if (response.data.manga_id) {
                                setTimeout(function() {
                                    // Usar URL relativa que funciona com o shortcode
                                    window.location.href = window.location.pathname + '?view=edit&id=' + response.data.manga_id;
                                }, 1000);
                            }
                        } else {
                                        ...
                                        <div class="manga-card-content">
                                            <div class="manga-card-header">
                                                ...
                                                <div class="manga-card-actions">
                                                    <a href="#" class="manga-btn manga-btn-secondary manga-btn-icon manga-tooltip edit-manga" data-tooltip="Edit" data-id="${manga.id}">
