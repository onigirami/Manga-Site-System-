...
// Verifica se a classe Elementor\Widget_Base existe antes de estender
if (!class_exists('\Elementor\Widget_Base')) {
    // Define uma classe vazia que não causa erros fatais se o Elementor não estiver instalado
    class Manga_Admin_Elementor_Widget {
        public function __construct() {}
    }
    // Retorna para não executar o resto do código
    return;
}
